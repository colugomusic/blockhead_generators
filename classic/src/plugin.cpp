...
blkhdgen_Error blkhdgen_sampler_get_waveform_positions(const blkhdgen_SamplerBuffer* buffer, blkhdgen_FrameCount n, float* out, float* derivatives, float* amp)
{
	if (!g_plugin) return blkhdgen_Error(Error::NotInitialized);
