...
namespace resonator { Plugin* g_plugin = nullptr; }
...
blink_Error blink_destroy_effect_instance(blink_EffectInstance instance)
{
	...
	const auto obj = (resonator::Instance*)(instance.proc_data);
...
blink_ResourceData blink_get_resource_data(const char* path)
{
	...
	const auto fs = cmrc::resonator::get_filesystem();
