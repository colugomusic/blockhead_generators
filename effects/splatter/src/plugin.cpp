...
namespace splatter { Plugin* g_plugin = nullptr; }
...
blink_PluginInfo blink_get_plugin_info()
{
	...
	out.uuid = "1979712f-faa4-4c06-8ebe-ad9bb62cc40f";
	out.name = "Splatter";
...
blink_Error blink_destroy_effect_instance(blink_EffectInstance instance)
{
	...
	const auto obj = (splatter::Instance*)(instance.proc_data);
...
blink_ResourceData blink_get_resource_data(const char* path)
{
	...
	const auto fs = cmrc::splatter::get_filesystem();
