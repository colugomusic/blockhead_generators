...
blink::ToggleSpec auto_attack()
{
	blink::ToggleSpec out;

	out.uuid = "edaadf71-6e8c-4e49-8517-412eee4e367e";
	out.name = "Auto-attack";
	out.default_value = true;
	out.flags = blink_ToggleFlags_ShowButton | blink_ToggleFlags_ShowInContextMenu;
...
{
	plugin->add_parameter(parameters::toggles::auto_attack());
